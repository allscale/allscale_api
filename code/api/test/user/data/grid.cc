...
namespace data {
	...
	TEST(GridRegion1D, Span) {
		...
		// test a simple grid region
		{
			...
			EXPECT_EQ(GridRegion<1>(5,10), GridRegion<1>::span(a,b));
		}
		...
		// test a composed grid region
		{
			...
			EXPECT_EQ(GridRegion<1>(5,19), GridRegion<1>::span(a,b));
		}
	...
	TEST(GridRegion2D, Span) {
		...
		// test a simple grid region
		{
			...
			EXPECT_EQ(GridRegion<2>(5,10), GridRegion<2>::span(a,b));
		}
		...
		// test a composed grid region
		{
			...
			EXPECT_EQ(GridRegion<2>(5,19), GridRegion<2>::span(a,b));
		}
