...
namespace reference {
	...
	public:
		...
		static InputStream& load(utils::Archive&) {
			...
			// unreachable, silences compiler errors and warnings
			return *reinterpret_cast<InputStream*>(0x1);
		}
	...
	public:
		...
		static OutputStream& load(utils::Archive&) {
			assert_not_implemented();
			// unreachable, silences compiler errors and warnings
			return *reinterpret_cast<OutputStream*>(0x1);
		}
	...
	public:
		...
		static MemoryMappedInput load(utils::Archive&) {
			assert_not_implemented();
			// unreachable, silences compiler errors and warnings
			return *reinterpret_cast<MemoryMappedInput*>(0x1);
		}
	...
	public:
		...
		static MemoryMappedOutput load(utils::Archive&) {
			assert_not_implemented();
			// unreachable, silences compiler errors and warnings
			return *reinterpret_cast<MemoryMappedOutput*>(0x1);
		}
