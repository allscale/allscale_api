...
#define assert_true(_COND)                                                                                                                                     \
	if(__allscale_unused auto x = insieme::utils::detail::LazyAssertion((bool)(_COND)))                                                                                 \
	std::cerr << "\nAssertion " #_COND " of " __FILE__ ":" __allscale_xstr_(__LINE__) " failed!\n"

#define assert_eq(_A, _B)                                                                                                                                      \
	if(__allscale_unused auto x = insieme::utils::detail::LazyAssertion((_A) == (_B)))                                                                                  \
...
#define assert_fail()                                                                                                                                          \
	if(__allscale_unused auto x = insieme::utils::detail::LazyAssertion(false)) std::cerr << "\nAssertion failed in " __FILE__ ":" __allscale_xstr_(__LINE__) " - "

#define assert_pred1(_P, _A)                                                                                                                                   \
	if(__allscale_unused auto x = insieme::utils::detail::LazyAssertion((bool)((_P)(_A))))                                                                              \
...
#define assert_pred2(_P, _A, _B)                                                                                                                               \
	if(__allscale_unused auto x = insieme::utils::detail::LazyAssertion((bool)((_P)(_A, _B))))                                                                          \
